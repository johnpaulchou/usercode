...
cmsswEnv = 'cd %s; . /uscmst1/prod/sw/cms/bashrc prod; eval `scramv1 runtime -sh`; cd -'
...
if __name__ =='__main__':
    ...
    if options.tarball:
        print os.path.basename( collection.tarfile )
        sys.exit()
    if options.untardir:
