...
path            = cms.untracked.string('/QCDDiJetPt800to1000/Summer08_IDEAL_V9_v1/GEN-SIM-RECO')
location        = cms.untracked.string('cmsdca2.fnal.gov')
numFiles        = cms.untracked.int32(12)
crossSection    = cms.untracked.double(9.421)
crossSectionErr = cms.untracked.double(0.0)
numEvents       = cms.untracked.int32(20880)
minPthat        = cms.untracked.double(800.)
maxPthat        = cms.untracked.double(1000.)
