...
path            = cms.untracked.string('/QCDDiJetPt1000to1400/Summer08_IDEAL_V9_v1/GEN-SIM-RECO')
location        = cms.untracked.string('cmsdca2.fnal.gov')
numFiles        = cms.untracked.int32(16)
crossSection    = cms.untracked.double(2.344)
crossSectionErr = cms.untracked.double(0.0)
numEvents       = cms.untracked.int32(24640)
minPthat        = cms.untracked.double(1000.)
maxPthat        = cms.untracked.double(1400.)
